...
const NAV: NavItem[] = [
  ...
  // 2 ─── MY VESSEL  (mixed — per-item flags)
  {
    ...
    children: [
      ...
      { label: "Projects",              to: "/orbit",                icon: LayersIcon, flagKey: "orbit-projects" },
      { label: "Small Boats",           to: "/orbit/boats",          icon: Sailboat, flagKey: "orbit-boats" },
      { label: "Approvals",             to: "/orbit/approvals",      icon: FileCheck2, flagKey: "orbit-approvals" },
