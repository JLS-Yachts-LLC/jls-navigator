import { r as reactExports, U as jsxRuntimeExports } from "./worker-entry-BezjW-Ra.js";
import { t as toast, s as supabase, P as PERMIT_STATUSES, u as useAuth, d as daysUntil, b as PERMIT_META, D as DMA_PHASES, e as expiryVariant } from "./router-Bznm5Sun.js";
import { c as composeRefs, u as useComposedRefs, a as cn, B as Button } from "./button-JPUfe_9j.js";
import { I as Input } from "./input-B_K_KDcR.js";
import { L as Label } from "./label-Bw1vn6qL.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, L as LoaderCircle, M as Mail, T as Textarea, C as CircleCheck } from "./select-DrNi6QXj.js";
import { f as useControllableState, u as useId, b as Primitive, d as composeEventHandlers, c as createContextScope, i as Portal$1, j as hideOthers, l as ReactRemoveScroll, k as useFocusGuards, F as FocusScope, D as DismissableLayer, p as createContext2, P as Plus } from "./Combination-DzMkfI48.js";
import { P as Presence } from "./index-CAqJP6Wb.js";
import { X, P as Pencil, T as Trash2 } from "./x-CnyX5g-w.js";
import { S as StatusPill } from "./status-pill-DwrzoG1N.js";
import { F as FileCheckCorner } from "./file-check-corner-tpGGbFcd.js";
import { c as createLucideIcon } from "./createLucideIcon-BIkeBdhh.js";
import { S as Save } from "./save-D6vEkkmQ.js";
import { S as Search } from "./search-DLAJIEdd.js";
const __iconNode$3 = [
        ...
        "div",
        {
          ...
          children: [
            uploading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin text-muted-foreground" }) : fileName ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "h-5 w-5 text-muted-foreground/50" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Tap or click to add a picture" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
...
function buildNotes(issueDate, remarks) {
  if (!issueDate && !remarks) return null;
  return JSON.stringify({ id: issueDate || void 0, rmk: remarks || void 0 });
}
function NavigationLicenseDialog({ yachts, editing, userId, onSaved }) {
  ...
  function buildPayload() {
    return {
      ...
      jls_quotation_number: form.jls_quotation_number || null,
      document_url: form.document_url || null,
      notes: buildNotes(issueDate, remarks)
      // Issue Date + Remarks
    };
  }
  async function doSave() {
  ...
  async function handleEmailSave() {
    ...
    try {
      ...
      const tmpl = templates?.[0];
      const yachtName = yachts.find((y) => y.id === form.yacht_id)?.vessel_name ?? "";
      const replace = (s) => s.replace(/\{\{boat_name\}\}/g, yachtName).replace(/\{\{holder_name\}\}/g, form.holder_name ?? "").replace(/\{\{expiry_date\}\}/g, form.expiry_date ?? "").replace(/\{\{issue_date\}\}/g, form.issue_date ?? "").replace(/\{\{authority\}\}/g, form.issuing_authority ?? "").replace(/\{\{applied_by\}\}/g, form.permit_number ?? "").replace(/\{\{quotation_number\}\}/g, form.jls_quotation_number ?? "").replace(/\{\{requested_by\}\}/g, form.dma_phase ?? "").replace(/\{\{license_no\}\}/g, form.preferred_inspection_date ?? "").replace(/\{\{actual_issue_date\}\}/g, issueDate);
