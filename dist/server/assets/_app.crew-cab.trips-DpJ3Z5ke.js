...
import { R as Route, N as Navigation } from "./route-CjY1Dlko.js";
...
function BoardRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/40 group hover:bg-muted/10 transition-colors h-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "w-20 px-2 py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity justify-end", children: [
      onEdit && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-3 w-3 text-muted-foreground" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/40 bg-primary/5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border-r border-border/40 px-2 py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "arrival_transport", children: "Arrival Transport" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "departure_transport", children: "Departure Transport" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "airport_transfer", children: "Airport Transfer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "delivery_collection", children: "Delivery & Collection" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "seaport_crew_change", children: "Seaport Crew Change" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "shorebased", children: "Shorebased" })
        ]
      }
    ) }),
...
function TripsPage() {
  ...
  async function confirmDelete() {
    ...
    const { error } = await supabase.from("crew_trips").delete().eq("id", deleteTarget.id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between border-b border-border bg-card/40 px-5 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5 ml-1", children: ["all", "arrival_transport", "departure_transport", "crew_pickup", "inhouse", "airport_transfer", "delivery_collection", "seaport_crew_change", "shorebased"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setFilter(f),
            className: cn(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-auto p-4", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-40 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border overflow-x-auto bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-1.5 border-b border-border/60 flex items-center gap-2 bg-muted/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Click any cell to edit inline · Enter or Tab to confirm · Add rows below" }),
        filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-[10px] text-muted-foreground italic", children: "No trips yet — add one below ↓" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTarget, onOpenChange: (o) => !o && setDeleteTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete trip?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          deleteTarget?.passenger_name ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: deleteTarget.passenger_name }),
            "'s trip will be permanently removed."
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.trip_type, onValueChange: (v) => setForm((f) => ({ ...f, trip_type: v })), children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "arrival_transport", children: "Arrival Transport" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "departure_transport", children: "Departure Transport" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "airport_transfer", children: "Airport Transfer" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "delivery_collection", children: "Delivery & Collection" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "seaport_crew_change", children: "Seaport Crew Change" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "shorebased", children: "Shorebased" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
